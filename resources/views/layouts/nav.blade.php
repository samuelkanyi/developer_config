...
<nav class="navbar-main">
    <section class="container">
        ...
        <ul class="nav-list">
            <li class="nav-list-item"><a class="list-item-link" href="/request">ASK</a></li>
            <li class="nav-list-item"><a class="list-item-link" href="/post">POST</a></li>
